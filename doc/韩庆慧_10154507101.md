...
# 产品技术方案
> 我在小组中主要负责的部分是客户端及服务器端dart语言的编写。设计具有查单词，添加生词本功能的网页版小应用时，主要用到的技术如下：
...
#### 我在小组中主要负责客户端及服务器端dart代码的编写及debug，主要实现的功能是从数据库获取搜索的单词，中文释意，例句等，添加
  生词本，删除记录，div的显示隐藏。雅思每日单词呈现以及少部分的html及css。
